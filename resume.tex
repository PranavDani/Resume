...
\resumeSubSubheading{\textbf{Compilers and Operating Systems Lab} $|$ Graduate Research Assistant $|$ New York, US}{May 2024 -- Present}
\resumeItemListStart
...
\resumeSubSubheading
{\textbf{Suven Consultants} $|$ Software Intern $|$ Mumbai, India}{Jun 2021 -- Aug 2021}
\resumeItemListStart
...
{\textbf{Computer Architecture} -- \textbf{\href{https://riscv.org/wp-content/uploads/2017/05/riscv-spec-v2.2.pdf}{RISC-V} Processor} $|$ \emph{SystemVerilog, GTKWave, C}}{Jun 2024 -- Oct 2024}
\resumeItemListStart
\resumeItem{Designed a synthesizable multi-cycle RISC-V processor (RV64IM ISA) with branch prediction and stalls.}
\resumeItem{Integrated 2 set-associative L1 caches, load/stores which uses \href{https://developer.arm.com/documentation/ihi0022/latest}{AXI4 protocol} to communicate with the memory.}
\resumeItemListEnd
\vspace{-17pt}
...
\resumeProjectHeading
{\textbf{\normalsize{Web Projects}} $|$ \emph{React.js, Node.js, Flask, PostgreSQL, Heroku, HTML, CSS, JS, SQL}}{Apr 2020 -- May 2024}
\resumeItemListStart
\resumeItem{\href{https://github.com/PranavDani/Expense-Tracker}{Expense Tracker} -- Feature-rich Flask based web app hosted on Heroku for tracking expenses.}
\resumeItem{\href{https://github.com/raunaqpahwa/cse564}{NYC Housing} -- Web app built with Node.js and D3 for visualizing NYC housing data and other parameters.}
\resumeItem{\href{https://github.com/PranavDani/short-terms}{Short-Terms} -- Chrome extension for summarizing web pages using Natural Language Processing and Spacy (before GPT).}
\resumeItemListEnd
