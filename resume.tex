...
\resumeItemListStart
\resumeItem{
  Built a CPU Energy Flamegraph tool using Linux perf\_events and \href{https://powerapi.org/}{PowerAPI} to monitor power consumption per function call, enhancing energy efficiency analysis. for developers.
}
...
\resumeItemListStart
\resumeItem{Built a persistent key-value store using Raft for leader election and data replication. Added snapshotting for quick revcovery.}
...
\resumeItemListStart
\resumeItem{Developed a personal expense management web app with bulk expense creation and CSV/Excel export, attracting 100+ users in the first month.
}
