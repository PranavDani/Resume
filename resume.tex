...
\section{Projects and Research}
    ...
    \resumeSubHeadingListStart
        ...
        \resumeProjectHeading
            {\textbf{Computer Architecture - \href{https://riscv.org/wp-content/uploads/2017/05/riscv-spec-v2.2.pdf}{RV64IM - RISCV} - In-Order Pipeline} $|$ \emph{Verilog, GTKWave}}{Jun 2024 -- Present}
            \resumeItemListStart
                ...
                \resumeItem{Created a functional RISCV processor with a Set-Associative cache and support for load/stores and ECALL instruction with pipeline flush.}
            \resumeItemListEnd
        \vspace{-17pt}
