...
\section{Projects and Research}
    ...
    \resumeSubHeadingListStart
        ...
        \resumeProjectHeading
            ...
            \resumeItemListStart
                \resumeItem{Implemented an instruction fetcher and a decoder for \textbf{RV64IM specs} which talks to physical memory over \href{https://developer.arm.com/documentation/ihi0022/latest}{AXI4 protocol}.}
                \resumeItem{Developed an ALU to execute instructions, and interact with reg file, supporting \textbf{pipeline stalls} on \textbf{RAW data hazards}.}
                \resumeItem{Created a functional RISCV processor with a \textbf{direct-mapped cache} and support for load/stores and \textbf{ECALL} instruction with pipeline flush.}
            \resumeItemListEnd
        \vspace{-17pt}
         ...
         \resumeProjectHeading
            ...
            \resumeItemListStart
                \resumeItem{Designed an asynchronous \textbf{disk logging protocol}, enhancing the write efficiency, resulting in a \textbf{94\%  latency reduction}.}
                \resumeItem{Introduced small file support with file type conversion handling. This resulted in a \textbf{reduction of 29\% disk IO} requests with unchanged logging and \textbf{a reduction of 91\% disk IO} requests with a new logging protocol.}
                \resumeItem{Implemented \textbf{ftruncate() syscall} for file truncation and seamless transition between "small" and regular files.}
            \resumeItemListEnd
        \vspace{-17pt}
