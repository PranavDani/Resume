...
\section{Publications}
    ...
    \resumeSubHeadingListStart
        \resumeProjectHeading
            {\textbf{\normalsize{BackGen - Backend Generator}} $|$ \emph{ICT4SD - Springer}}{August 2023}
            \resumeItemListStart
...
\section{Projects}
    ...
    \resumeSubHeadingListStart
        \resumeProjectHeading
            {\textbf{\normalsize{Fault Tolerant Sharded Key-Value Store With Transactions using Raft}} $|$ \emph{C++}}{August 2023 -- December 2023}
            \resumeItemListStart
                ...
                \resumeItem{Implemented Sharding using consistent hashing and automated partition rebalancing during node joins/departures.}
        ...
        \resumeProjectHeading
            ...
            \resumeItemListStart
                \resumeItem{Designed and built a web application for finding roommates.}
                \resumeItem{Has features like, filtering rooms based on user profiles, groups, and personal preferences.}
            \resumeItemListEnd
        \vspace{-19pt}
        ...
        \resumeProjectHeading
            ...
            \resumeItemListStart
                \resumeItem{A browser extension for summarizing website content with a single click.}
        ...
        \resumeProjectHeading
            ...
            \resumeItemListStart
                \resumeItem{An easy-to-use E-commerce platform for creating Granites and Marble quotations.}
        ...
        \resumeProjectHeading
            ...
            \resumeItemListStart
                \resumeItem{A web app for recording and managing personal expenses which also supports creating bulk expenses and importing user data in CSV and Excel formats for personalized editing.}
...
\section{Extracurricular Activity}
    ...
    \resumeSubHeadingListStart
        \resumeProjectHeading
            {\textbf{\normalsize{Our Tech Community (OTC)}} $|$ \normalfont\href{https://ourtech.community}{ourtech.community} $|$ \emph{Admin}}{August 2023}
            \resumeItemListStart
