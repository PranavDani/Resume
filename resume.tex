...
{\textbf{\href{https://riscv.org/wp-content/uploads/2017/05/riscv-spec-v2.2.pdf}{\color{black}RISC-V} CPU - RV64IM} $|$ \emph{Verilog, GTKWave}}{Jun 2024 -- Present}
\resumeItemListStart
\resumeItem{Designed a five + stage in-order pipeline for RV64IM spec extension which talks to the physical memory over \href{https://developer.arm.com/documentation/ihi0022/latest}{\color{black}\textbf{AXI4 protocol}}.}
...
\resumeItemListStart
\resumeItem{
  Developed an asynchronous disk logging protocol for \href{https://pdos.csail.mit.edu/6.828/2012/xv6.html}{\color{black}\textbf{xv6}}, optimizing write efficiency by caching writes and writing to disk when writing, achieving a 94\% reduction in write latency.
}
\resumeItem{
...
\resumeProjectHeading
{\textbf{\normalsize{\href{https://raft.github.io/raft.pdf}{\color{black}Raft} Implementation - Consensus Algorithm}} $|$ \emph{C++}}{Aug 2023 -- Dec 2023}
\resumeItemListStart
...
\resumeProjectHeading
{\textbf{\normalsize{BackGen - Backend Generator}} $|$ \emph{ICT4SD $|$ \href{https://link.springer.com/chapter/10.1007/978-981-99-6568-7_34}{\color{black}Springer}}}{Jan 2023 - Aug 2023}
\resumeItemListStart
...
\resumeProjectHeading
{\textbf{\normalsize{Expense Tracker}} $|$ \emph{Flask, PostgreSQL, Heroku, HTML, CSS, JS} $|$ \href{https://github.com/PranavDani/Expense-Tracker}{\color{black}GitHub}}{Apr 2021 -- Jun 2021}
\resumeItemListStart
...
\resumeSubHeadingListStart
\resumeProjectHeading
{\textbf{\normalsize{Our Tech Community (OTC)}} $|$ \normalfont\href{https://ourtech.community}{\color{black}ourtech.community} $|$ \emph{Admin}}{May 2022 - Present}
\resumeItemListStart
\resumeItem{Hosted 300+ hours of weekly \href{https://catchup.ourtech.community}{\color{black}OTC CatchUp} technical discussions, organized two in-person \href{https://meetup.ourtech.community}{\color{black}OTC MeetUp} events with 60+ attendees.}
\resumeItemListEnd
\vspace{-18pt}
\resumeSubHeadingListEnd
\vspace{-8pt}
