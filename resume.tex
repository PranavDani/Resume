    ...
    \begin{itemize}[leftmargin=0.2in, label={}]
        {\item{
            \begin{tabular}{ l@{\hskip 0.2in} l }
                 \textbf{Languages and Frameworks}: C, C++, Python, Java, Go, React.js, Node.js (Express.js), Flask, HTML, CSS, JS 
                 \\ 
...
\section{Projects and Research}
    ...
    \resumeSubHeadingListStart
        \resumeProjectHeading
            ...
            \resumeItemListStart
                \resumeItem{Developed a \textbf{persistent linearizable key-value store} utilizing the \textbf{Raft consensus algorithm} for leader election and data replication in an \textbf{asynchronous environment}. Implemented \textbf{log compaction} with \textbf{Snapshots}.}
