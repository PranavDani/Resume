...
{\textbf{\href{https://riscv.org/wp-content/uploads/2017/05/riscv-spec-v2.2.pdf}{RISC-V} CPU - RV64IM Implementation}\hspace{0pt}$|$\hspace{0pt}\emph{\textbf{Verilog, GTKWave, C}}}{Jun 2024 -- Oct 2024}
\resumeItemListStart
\resumeItem{Designed a synthesizable multi-cycle in-order pipeline RISC-V processor which communicates with memory over \href{https://developer.arm.com/documentation/ihi0022/latest}{\textbf{AXI4 protocol}}.}
...
\resumeProjectHeading
{\textbf{Enhanced xv6 File System: Optimized Logging and Small File Support}\hspace{0pt}$|$\hspace{0pt}\emph{\textbf{C, QEMU}}}{Mar 2024 -- May 2024}
\resumeItemListStart
\resumeItem{
...
\resumeProjectHeading
{\textbf{\normalsize{Distributed Key-Value Store with \href{https://raft.github.io/raft.pdf}{Raft} Consensus}}\hspace{0pt}$|$\hspace{0pt}\emph{\textbf{C++}}}{Aug 2023 -- Dec 2023}
\resumeItemListStart
...
\resumeProjectHeading
{\textbf{\normalsize{BackGen - GoLang Backend Generator}}\hspace{0pt}$|$\hspace{0pt}\emph{ICT4SD $|$ \href{https://link.springer.com/chapter/10.1007/978-981-99-6568-7_34}{Springer}}}{Jan 2023 -- Aug 2023}
\resumeItemListStart
...
\resumeProjectHeading
{\textbf{\normalsize{Expense Tracker}}\hspace{0pt}$|$\hspace{0pt}\emph{\textbf{Flask, PostgreSQL, Heroku, HTML, CSS, JS}} $|$ \href{https://github.com/PranavDani/Expense-Tracker}{GitHub}}{Apr 2021 -- Jun 2021}
\resumeItemListStart
...
\begin{itemize}[leftmargin=0.2in, label={}]
  \item \textbf{Languages and Databases:} C, C++, Java, Python, Go, Verilog, PostgreSQL, MySQL, MongoDB\\
