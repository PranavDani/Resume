...
\resumeItemListStart
\resumeItem{
  Developed an Energy Flamegraph tool using Linux perf\_events and PowerAPI to trace CPU call chains and monitor power consumption per cgroup. This tool generates both CPU and energy \href{https://www.brendangregg.com/flamegraphs.html}{flamegraphs} from the same execution trace.
}
\resumeItem{
...
\begin{itemize}[leftmargin=0.2in, label={}]
  {\item{
        \begin{tabular}{ l@{\hskip 0.2in} l }
          \textbf{Languages}: C, C++, Java, Python, JS, Verilog & \qquad \textbf{Tools}: qemu, perl, bash, GTKWave, Git \\
