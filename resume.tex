...
\resumeItemListStart
\resumeItem{
  Built a CPU Energy Flamegraph tool using Linux perf\_events and \href{https://powerapi.org/}{PowerAPI} to monitor power consumption per function call, improving energy efficiency analysis for developers.
}
...
{\textbf{\href{https://riscv.org/wp-content/uploads/2017/05/riscv-spec-v2.2.pdf}{RISC-V} CPU - RV64IM} $|$ \emph{Verilog, GTKWave, C}}{Jun 2024 -- Present}
\resumeItemListStart
...
\resumeItemListStart
\resumeItem{Built an expense tracker web app with bulk expense creation and CSV/Excel export, gaining 100+ users in the first month.
}
