...
\resumeItem{Implemented an ALU to execute instructions, and interact with register file, supporting pipeline stalls.}
\resumeItem{Integrated branch prediction, 2 set-associative L1 caches, load/stores and ECALL (syscall) instructions with pipeline flush.}
\resumeItemListEnd
\vspace{-17pt}
...
\resumeItem{\textbf{\href{https://github.com/PranavDani/short-terms}{\textcolor{black}{Short-Terms}}} -- Chrome extension for summarizing web pages using Natural Language Processing and Spacy (before GPT).}
\resumeItemListEnd
