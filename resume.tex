...
\section{Projects and Research}
    ...
    \resumeSubHeadingListStart
        ...
        \resumeProjectHeading
            {\textbf{Computer Architecture - \href{https://riscv.org/wp-content/uploads/2017/05/riscv-spec-v2.2.pdf}{RV64IM - RISCV} - Five Stage In-Order Pipeline} $|$ \emph{Verilog, GTKWave}}{Jun 2024 -- Present}
            \resumeItemListStart
                \resumeItem{Designed a five-stage in-order pipeline for RV64IM specs which talks to physical memory over \href{https://developer.arm.com/documentation/ihi0022/latest}{AXI4 protocol}.}
        ...
        \vspace{-17pt}
         ...
         \resumeProjectHeading
            {\textbf{Kernel Programming - File Systems} $|$ \emph{C, qemu}}{Mar 2024 -- May 2024}
            \resumeItemListStart
                \resumeItem{Designed an asynchronous disk logging protocol for xv6, enhancing the write efficiency, resulting in a 94\%  latency reduction.}
                \resumeItem{Introduced small file support with file type conversion handling, reducing disk IO requests with unchanged logging protocol by 29\% and reducing disk IO requests with the new logging protocol by 91\%.}
