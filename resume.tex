...
\resumeItemListStart
\resumeItem{
  Developed a tool using linux perf\_events and PowerAPI to trace CPU call chains and monitor power consumption, generating both CPU and energy \href{https://www.brendangregg.com/flamegraphs.html}{flamegraphs} from the same execution trace.
}
\resumeItem{
  Currently developing a tool to collect GPU API and kernel launch traces, along with power data, using CUPTI and NVML for the creation of Energy Flamegraphs.
}
\resumeItemListEnd
\vspace{-3pt}
...
\resumeItem{Integrated \textbf{Printable interface} to generate printable reports in PDF format using Java AWT and Graphics Library.}
\resumeItemListEnd
\vspace{-3pt}
\resumeSubHeadingListEnd
\vspace{-18pt}
...
\begin{itemize}[leftmargin=0.2in, label={}]
  {\item{
        \begin{tabular}{ l@{\hskip 0.2in} l }
          ...
          \textbf{Tools}: Git, qemu, perl, bash, GTKWave        & \textbf{CI/CD}: GitHub Actions
        \end{tabular}
        }}
\end{itemize}
\vspace{-22pt}
...
\resumeItem{
  Implemented ftruncate() syscall for file truncation and transition between "small" and regular files.
}
\resumeItemListEnd
\vspace{-17pt}
...
\resumeItemListStart
\resumeItem{Hosted 300+ hours of weekly \href{https://catchup.ourtech.community}{OTC CatchUp} sessions, organized two in-person \href{https://meetup.ourtech.community}{OTC MeetUp} events with 60+ attendees.}
\resumeItemListEnd
\vspace{-18pt}
\resumeSubHeadingListEnd
\vspace{-8pt}
